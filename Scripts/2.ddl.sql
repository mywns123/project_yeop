-- Laundry
DROP SCHEMA IF EXISTS laundry_ju;

-- Laundry
CREATE SCHEMA laundry_ju;

-- 세탁물 주문표
CREATE TABLE laundry_ju.Order (
...
-- 세탁물 코드표
CREATE TABLE laundry_ju.Laundry (
...
-- 세탁물 코드표
ALTER TABLE laundry_ju.Laundry
...
-- 고객정보
CREATE TABLE laundry_ju.Customer (
...
-- 고객정보
ALTER TABLE laundry_ju.Customer
